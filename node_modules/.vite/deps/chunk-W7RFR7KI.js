...
function from3(envelope, options = {}) {
...
function serialize3(envelope, options = {}) {
  ...
  return concat(serializedType3, fromHex(serialized));
}
...
function from6(envelope, options = {}) {
  const { signature } = options;
...
//# sourceMappingURL=chunk-W7RFR7KI.js.map
