...
async function getNFTAsset(options) {
  ...
  switch (true) {
    case erc721: {
      const { getNFT } = await import("./getNFT-SEK6ZPFA.js");
      return getNFT(options);
    }
    case erc1155: {
      const { getNFT } = await import("./getNFT-675FE6N4.js");
      return getNFT(options);
    }
    default: {
...
async function isListingValid(options) {
  ...
  if (erc721) {
    const [{ isApprovedForAll }, { getApproved }, { ownerOf }] = await Promise.all([
      import("./isApprovedForAll-USAFIPY5.js"),
      import("./getApproved-4MXT2W5J.js"),
      import("./ownerOf-RTA5B6MC.js")
    ]);
  ...
  if (erc1155) {
    const [{ isApprovedForAll }, { balanceOf }] = await Promise.all([
      import("./isApprovedForAll-2MA4BAR2.js"),
      import("./balanceOf-ZU6V4JMC.js")
    ]);
...
//# sourceMappingURL=chunk-W4BTW4RK.js.map
