...
} from "./chunk-CZULJHI3.js";
import {
  getDefaultAccountFactory
} from "./chunk-XE2GVLJD.js";
import {
  isContractDeployed
} from "./chunk-33VL7WFU.js";
import {
  getSignPayload,
  toRpcList
} from "./chunk-WQRC3GBT.js";
import {
  fromHex
} from "./chunk-LE5UI3U6.js";
import {
  isZkSyncChain
} from "./chunk-7VM5VBVJ.js";
import {
  isInsufficientFundsError,
  trackInsufficientFundsError,
  trackTransaction
} from "./chunk-7UEO6R6I.js";
import {
  getTypesForEIP712Domain,
  serializeTypedData,
  validateTypedData,
  withTimeout
} from "./chunk-FF7NFOKB.js";
import {
  stringify
...
// node_modules/thirdweb/dist/esm/wallets/base-account/base-account-wallet.js
function baseAccountWalletSDK(args) {
  ...
  return {
    autoConnect: async (options) => {
      const { autoConnectBaseAccountSDK } = await import("./base-account-web-TFLDZWUB.js");
    ...
    connect: async (options) => {
      const { connectBaseAccountSDK } = await import("./base-account-web-TFLDZWUB.js");
      const provider = await args.providerFactory();
...
function coinbaseWalletSDK(args) {
  ...
  return {
    autoConnect: async (options) => {
      const { autoConnectCoinbaseWalletSDK } = await import("./coinbase-web-YH7ETNG5.js");
      const provider = await args.providerFactory();
    ...
    connect: async (options) => {
      const { connectCoinbaseWalletSDK } = await import("./coinbase-web-YH7ETNG5.js");
      const provider = await args.providerFactory();
...
function ecosystemWallet(...args) {
  ...
  return createInAppWallet({
    connectorFactory: async (client) => {
      const { InAppWebConnector } = await import("./web-connector-YZ3HGLT2.js");
...
function smartWallet(createOptions) {
  ...
  return {
    autoConnect: async (options) => {
      const { connectSmartAccount: connectSmartWallet } = await import("./smart-6AZAM4ZI.js");
    ...
    connect: async (options) => {
      const { connectSmartAccount } = await import("./smart-6AZAM4ZI.js");
    ...
    disconnect: async () => {
      if (account) {
        const { disconnectSmartAccount } = await import("./smart-6AZAM4ZI.js");
...
function createWallet(...args) {
  ...
  switch (true) {
    ...
    case id === COINBASE: {
      ...
      return coinbaseWalletSDK({
        ...
        onConnectRequested: async (provider) => {
          const { showCoinbasePopup } = await import("./utils-3TOKHJDU.js");
    ...
    default: {
      ...
      const wallet = {
        autoConnect: async (options) => {
          const { injectedProvider: injectedProvider2 } = await import("./mipdStore-OXH2CADG.js");
          if (id !== "walletConnect" && injectedProvider2(id)) {
            const { autoConnectEip1193Wallet: autoConnectEip1193Wallet2 } = await import("./injected-BSQW7GMH.js");
          ...
          if (options && "client" in options) {
            const { autoConnectWC } = await import("./controller-JMUPDPYH.js");
        ...
        connect: async (options) => {
          async function wcConnect(wcOptions) {
            var _a;
            const { connectWC } = await import("./controller-JMUPDPYH.js");
            let qrOverlay;
            try {
                  ...
                  onDisplayUri: ((_a = wcOptions.walletConnect) == null ? void 0 : _a.onDisplayUri) || (async (uri) => {
                    ...
                    if (typeof window !== "undefined" && typeof document !== "undefined") {
                      if (isMobile()) {
                        ...
                        try {
                          const { createQROverlay } = await import("./qr-overlay-LUR2CX6N.js");
                          if (qrOverlay) {
                            qrOverlay.destroy();
                          }
          ...
          if (injectedProvider2(id) && !forceWalletConnectOption) {
            const { connectEip1193Wallet: connectEip1193Wallet2 } = await import("./injected-BSQW7GMH.js");
...
function createAccount({ provider, address, client, id }) {
  const account = {
      ...
      const params = [
        {
          ...
          authorizationList: tx.authorizationList ? toRpcList(tx.authorizationList) : void 0,
    ...
    async signAuthorization(authorization) {
      ...
      const parsedSignature = fromHex(signature);
      ...
      try {
        const result = await provider.request({
          ...
          params: [
            ...
            chainIdFilter ? [numberToHex(chainIdFilter)] : void 0
          ]
        });
...
//# sourceMappingURL=chunk-DFVXO7FA.js.map
