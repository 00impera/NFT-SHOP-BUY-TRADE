import {
  ConnectingScreen
} from "./chunk-W5I4GT7Z.js";
import {
  AllWalletsUI_default,
  ConnectWalletSocialOptions,
  LAST_USED_BADGE_VERTICAL_RESERVED_SPACE,
  LoadingScreen,
  Spinner,
  TextDivider,
  WalletButtonEl,
...
import {
  ...
  useQuery,
  useWalletInfo
} from "./chunk-DEQZRX5E.js";
import {
  linkProfile,
  preAuthenticate
} from "./chunk-B5RMHE7R.js";
import {
  createWallet,
  getInstalledWalletProviders,
  isMobile,
  openWindow
} from "./chunk-DFVXO7FA.js";
import {
  formatWalletConnectUrl
} from "./chunk-PXX7E7JU.js";
import {
  isEcosystemWallet
} from "./chunk-QDEEV5NE.js";
import {
  hasStoredPasskey
} from "./chunk-JXDMZFUH.js";
import {
  loginWithOauthRedirect
} from "./chunk-BLXDFM2A.js";
import {
  webLocalStorage
...
async function getInAppWalletLocale(localeId) {
  switch (localeId) {
    case "es_ES":
      return (await import("./es-VVFQHO3J.js")).default;
    case "ja_JP":
      return (await import("./ja-XCZD4VBI.js")).default;
    case "tl_PH":
      return (await import("./tl-O72GL2YN.js")).default;
    case "vi_VN":
      return (await import("./vi-XUXT7BJI.js")).default;
    case "de_DE":
      return (await import("./de-VOQKJZU7.js")).default;
    case "ko_KR":
      return (await import("./kr-3EJCRFHV.js")).default;
    case "fr_FR":
      return (await import("./fr-5XNHROLG.js")).default;
    case "ru_RU":
      return (await import("./ru-OASC2D5V.js")).default;
    case "pt_BR": {
      return (await import("./br-VURKNVSJ.js")).default;
    }
    case "zh_CN":
      return (await import("./zh-P5JKTWDS.js")).default;
    default:
      return (await import("./en-NNPBSAFH.js")).default;
  }
}

// node_modules/thirdweb/dist/esm/react/web/wallets/in-app/useInAppWalletLocale.js
function useInAppWalletLocale(localeId) {
  const [locale, setLocale] = (0, import_react3.useState)(void 0);
...
function GuestLogin(props) {
  ...
  return (0, import_jsx_runtime.jsx)(Container, { animate: "fadein", flex: "column", fullHeight: true, className: "tw-guest-login-screen", children: (0, import_jsx_runtime.jsxs)(Container, { expand: true, flex: "column", p: "lg", style: {
    paddingBottom: 0
  }, children: [props.goBack && (0, import_jsx_runtime.jsx)(ModalHeader, { onBack: props.goBack, title: locale.title }), props.size === "compact" ? (0, import_jsx_runtime.jsx)(Spacer, { y: "xl" }) : null, (0, import_jsx_runtime.jsxs)(Container, { center: "both", expand: true, flex: "column", style: {
    minHeight: "250px",
    textAlign: "center"
  }, children: [status !== "error" && (0, import_jsx_runtime.jsxs)(Container, { animate: "fadein", children: [(0, import_jsx_runtime.jsx)(Text, { center: true, color: "primaryText", multiline: true, style: {
    maxWidth: "250px"
  }, children: "Generating your guest account" }), (0, import_jsx_runtime.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime.jsx)(Container, { center: "x", flex: "row", children: (0, import_jsx_runtime.jsx)(Spinner, { color: "accentText", size: "lg" }) }), (0, import_jsx_runtime.jsx)(Spacer, { y: "xxl" })] }), status === "error" && (0, import_jsx_runtime.jsxs)(Container, { animate: "fadein", children: [authError ? (0, import_jsx_runtime.jsx)(Text, { center: true, color: "danger", children: authError }) : (0, import_jsx_runtime.jsx)(Text, { color: "danger", children: locale.failed }), (0, import_jsx_runtime.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime.jsx)(Button, { onClick: handleGuestLogin, variant: "primary", children: locale.retry }), (0, import_jsx_runtime.jsx)(Spacer, { y: "xxl" })] })] })] }) });
}
...
// node_modules/thirdweb/node_modules/input-otp/dist/index.mjs
...
function OTPInput(props) {
  return (0, import_jsx_runtime2.jsx)(OTPInputContainer, { className: "tw-otp-input-container", children: (0, import_jsx_runtime2.jsx)(Lt, { maxLength: 6, onChange: (newValue) => {
    props.setValue(newValue);
  }, onComplete: () => {
    props.onEnter();
  }, render: ({ slots }) => (0, import_jsx_runtime2.jsx)(Container, { center: "both", flex: "row", gap: "xs", children: slots.map((slot, idx) => (
...
function OTPLoginUI(props) {
  ...
  const [otpInput, setOtpInput] = (0, import_react6.useState)("");
  const [verifyStatus, setVerifyStatus] = (0, import_react6.useState)("idle");
  const [error, setError] = (0, import_react6.useState)();
  const [accountStatus, setAccountStatus] = (0, import_react6.useState)({
    type: "sending"
  });
  ...
  const [screen] = (0, import_react6.useState)("base");
  const sendEmailOrSms = (0, import_react6.useCallback)(async () => {
    setOtpInput("");
  ...
  const emailSentOnMount = (0, import_react6.useRef)(false);
  ...
  if (screen === "base") {
    return (0, import_jsx_runtime3.jsxs)(Container, { animate: "fadein", flex: "column", fullHeight: true, className: "tw-otp-login-screen", children: [(0, import_jsx_runtime3.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime3.jsx)(ModalHeader, { onBack: goBack, title: locale.signIn }) }), (0, import_jsx_runtime3.jsx)(Container, { center: "y", expand: true, flex: "column", children: (0, import_jsx_runtime3.jsxs)("form", { onSubmit: (e) => {
      e.preventDefault();
    }, children: [(0, import_jsx_runtime3.jsxs)(Container, { center: "x", flex: "column", px: "lg", children: [!isWideModal && (0, import_jsx_runtime3.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime3.jsx)(Text, { className: "tw-screen-title", children: locale.emailLoginScreen.enterCodeSendTo }), (0, import_jsx_runtime3.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime3.jsx)(Text, { color: "primaryText", children: "email" in userInfo ? userInfo.email : userInfo.phone }), (0, import_jsx_runtime3.jsx)(Spacer, { y: "xl" })] }), (0, import_jsx_runtime3.jsx)(OTPInput, { digits: 6, isInvalid: verifyStatus === "invalid", onEnter: () => {
      verify(otpInput);
    }, setValue: (value) => {
      setOtpInput(value);
      setVerifyStatus("idle");
    }, value: otpInput }), verifyStatus === "invalid" && (0, import_jsx_runtime3.jsxs)(FadeIn, { children: [(0, import_jsx_runtime3.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime3.jsx)(Text, { center: true, color: "danger", size: "sm", className: "tw-invalid-code-text", children: locale.emailLoginScreen.invalidCode })] }), verifyStatus === "linking_error" && (0, import_jsx_runtime3.jsxs)(FadeIn, { children: [(0, import_jsx_runtime3.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime3.jsx)(Text, { center: true, color: "danger", size: "sm", className: "tw-screen-error", children: error || "Failed to verify code" })] }), verifyStatus === "payment_required" && (0, import_jsx_runtime3.jsxs)(FadeIn, { children: [(0, import_jsx_runtime3.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime3.jsx)(Text, { center: true, color: "danger", size: "sm", className: "tw-screen-error", children: locale.maxAccountsExceeded })] }), (0, import_jsx_runtime3.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime3.jsx)(Container, { px: isWideModal ? "xxl" : "lg", children: verifyStatus === "verifying" ? (0, import_jsx_runtime3.jsx)(Container, { animate: "fadein", center: "x", flex: "row", children: (0, import_jsx_runtime3.jsx)(Spinner, { color: "accentText", size: "lg" }) }) : (0, import_jsx_runtime3.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime3.jsx)(Button, { onClick: () => verify(otpInput), style: {
      width: "100%"
    }, type: "submit", variant: "accent", className: "tw-verify-button", children: locale.emailLoginScreen.verify }) }, "btn-container") }), (0, import_jsx_runtime3.jsx)(Spacer, { y: "xl" }), !isWideModal && (0, import_jsx_runtime3.jsx)(Line, {}), (0, import_jsx_runtime3.jsxs)(Container, { gap: "sm", p: isWideModal ? void 0 : "lg", flex: "column", children: [accountStatus.type === "error" && (0, import_jsx_runtime3.jsx)(Text, { center: true, color: "danger", size: "sm", className: "tw-screen-error", children: accountStatus.message || locale.emailLoginScreen.failedToSendCode }), accountStatus.type === "sending" && (0, import_jsx_runtime3.jsxs)(Container, { center: "both", flex: "row", gap: "xs", style: {
      textAlign: "center"
    }, children: [(0, import_jsx_runtime3.jsx)(Text, { size: "sm", children: locale.emailLoginScreen.sendingCode }), (0, import_jsx_runtime3.jsx)(Spinner, { color: "secondaryText", size: "xs" })] }), accountStatus.type !== "sending" && (0, import_jsx_runtime3.jsx)(LinkButton, { onClick: countdown === 0 ? sendEmailOrSms : void 0, style: {
      cursor: countdown > 0 ? "default" : "pointer",
      opacity: countdown > 0 ? 0.5 : 1
    }, className: "tw-resend-button", type: "button", children: countdown > 0 ? `Resend code in ${countdown} seconds` : locale.emailLoginScreen.resendCode })] })] }) })] });
  }
  return null;
}
...
function PassKeyLogin(props) {
  ...
  return (0, import_jsx_runtime7.jsxs)(Container, { animate: "fadein", flex: "column", fullHeight: true, children: [(0, import_jsx_runtime7.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime7.jsx)(ModalHeader, { onBack: props.onBack, title: props.isLinking ? locale.passkeys.linkPasskey : locale.passkeys.title }) }), (0, import_jsx_runtime7.jsx)(Container, { center: "y", expand: true, flex: "column", px: size === "wide" ? "xxl" : "lg", children: (0, import_jsx_runtime7.jsxs)("div", { children: [screen === "loading" && (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [(0, import_jsx_runtime7.jsx)(LoadingScreen, {}), (0, import_jsx_runtime7.jsx)(Spacer, { y: "xxl" })] }), screen === "select" && (0, import_jsx_runtime7.jsx)(SelectLoginMethod, { onSignin: () => {
    setScreen("login");
  }, onSignup: () => {
    setScreen("signup");
  } }), screen === "login" && (0, import_jsx_runtime7.jsx)(LoginScreen, { chain, client, done, isLinking: props.isLinking, onCreate: () => {
    setScreen("signup");
  }, wallet }), screen === "signup" && (0, import_jsx_runtime7.jsx)(SignupScreen, { chain, client, done, isLinking: props.isLinking, wallet })] }) })] });
}
function LoginScreen(props) {
  const { wallet, done, client, chain } = props;
  const [status, setStatus] = (0, import_react8.useState)("loading");
  ...
  if (status === "loading") {
    return (0, import_jsx_runtime7.jsx)(LoadingState, { icon: (0, import_jsx_runtime7.jsx)(FingerPrintIcon, { size: iconSize.xxl }), subtitle: "A pop-up prompt will appear to sign-in and verify your passkey", title: "Requesting Passkey" });
  }
  if (status === "error") {
    return (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [(0, import_jsx_runtime7.jsx)(ErrorState, { onTryAgain: login, title: error || "Failed to Login" }), (0, import_jsx_runtime7.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime7.jsx)(Button, { fullWidth: true, onClick: props.onCreate, variant: "outline", children: "Create a new Passkey" }), (0, import_jsx_runtime7.jsx)(Spacer, { y: "lg" })] });
  }
  return null;
}
function SignupScreen(props) {
  ...
  if (status === "loading") {
    return (0, import_jsx_runtime7.jsx)(LoadingState, { icon: (0, import_jsx_runtime7.jsx)(FingerPrintIcon, { size: iconSize.xxl }), subtitle: "A pop-up prompt will appear to sign-in and verify your passkey", title: "Creating Passkey" });
  }
  if (status === "error") {
...
function SelectLoginMethod(props) {
  return (0, import_jsx_runtime7.jsxs)(Container, { children: [(0, import_jsx_runtime7.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime7.jsx)(Container, { center: "x", color: "accentText", flex: "row", children: (0, import_jsx_runtime7.jsx)(FingerPrintIcon, { size: iconSize["4xl"] }) }), (0, import_jsx_runtime7.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime7.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime7.jsx)(Button, { fullWidth: true, onClick: props.onSignup, variant: "accent", children: "Create a Passkey" }), (0, import_jsx_runtime7.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime7.jsx)(Button, { fullWidth: true, onClick: props.onSignin, variant: "outline", children: "I have a Passkey" }), (0, import_jsx_runtime7.jsx)(Spacer, { y: "lg" })] });
}
...
function SocialLogin(props) {
  ...
  const [authError, setAuthError] = (0, import_react9.useState)(void 0);
  const { done, wallet } = props;
  ...
  const socialLoginStarted = (0, import_react9.useRef)(false);
  ...
  return (0, import_jsx_runtime8.jsx)(Container, { animate: "fadein", flex: "column", fullHeight: true, className: "tw-social-login-screen", children: (0, import_jsx_runtime8.jsxs)(Container, { expand: true, flex: "column", p: "lg", style: {
    paddingBottom: 0
  }, children: [props.goBack && (0, import_jsx_runtime8.jsx)(ModalHeader, { onBack: props.goBack, title: props.isLinking ? props.connectLocale.manageWallet.linkProfile : locale.title }), props.size === "compact" ? (0, import_jsx_runtime8.jsx)(Spacer, { y: "xl" }) : null, (0, import_jsx_runtime8.jsxs)(Container, { center: "both", expand: true, flex: "column", style: {
    minHeight: "250px",
    textAlign: "center"
  }, children: [status !== "error" && (0, import_jsx_runtime8.jsxs)(Container, { animate: "fadein", children: [(0, import_jsx_runtime8.jsx)(Text, { center: true, color: "primaryText", multiline: true, style: {
    maxWidth: "250px"
  }, children: locale.instruction }), (0, import_jsx_runtime8.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime8.jsx)(Container, { center: "x", flex: "row", children: (0, import_jsx_runtime8.jsx)(Spinner, { color: "accentText", size: "lg" }) }), (0, import_jsx_runtime8.jsx)(Spacer, { y: "xxl" })] }), status === "error" && (0, import_jsx_runtime8.jsxs)(Container, { animate: "fadein", children: [authError ? (0, import_jsx_runtime8.jsx)(Text, { center: true, color: "danger", children: authError }) : (0, import_jsx_runtime8.jsx)(Text, { color: "danger", children: locale.failed }), (0, import_jsx_runtime8.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime8.jsx)(Button, { onClick: handleSocialLogin, variant: "primary", children: locale.retry }), (0, import_jsx_runtime8.jsx)(Spacer, { y: "xxl" })] })] })] }) });
}
...
function InAppWalletSelectionUI(props) {
  ...
  if (props.size === "wide" || screen !== reservedScreens.main && props.size === "compact") {
    return (0, import_jsx_runtime9.jsx)(WalletEntryButton, { badge: void 0, client: props.client, connectLocale: props.connectLocale, isActive: screen === props.wallet, recommendedWallets: props.recommendedWallets, selectWallet: () => {
      setData({});
      props.select();
    }, wallet: props.wallet });
  }
  if (!locale) {
    return (0, import_jsx_runtime9.jsx)(LoadingScreen, { height: "195px" });
  }
  return (0, import_jsx_runtime9.jsx)(ConnectWalletSocialOptions, { chain: props.chain, client: props.client, disabled: props.disabled, done: props.done, goBack: props.goBack, locale, select: props.select, size: props.size, wallet: props.wallet });
}
...
async function getSmartWalletLocale(localeId) {
  switch (localeId) {
    case "es_ES":
      return (await import("./es-FPASZTI3.js")).default;
    case "ja_JP":
      return (await import("./ja-M74FMOIF.js")).default;
    case "tl_PH":
      return (await import("./tl-FQWA5XVZ.js")).default;
    case "vi_VN":
      return (await import("./vi-ZEAF2JHG.js")).default;
    case "de_DE":
      return (await import("./de-4G44URPK.js")).default;
    case "ko_KR":
      return (await import("./kr-LUNHYQT7.js")).default;
    case "fr_FR":
      return (await import("./fr-RYGXHENA.js")).default;
    case "ru_RU":
      return (await import("./ru-A3KGLRI7.js")).default;
    case "pt_BR": {
      return (await import("./br-T7GMUCD7.js")).default;
    }
    case "zh_CN":
      return (await import("./zh-IREQPY6Z.js")).default;
    default:
      return (await import("./en-KLHVZCUD.js")).default;
  }
}
...
async function getInjectedWalletLocale(locale) {
  switch (locale) {
    case "es_ES":
      return (await import("./es-LAJDOFY7.js")).default;
    case "ja_JP":
      return (await import("./ja-FRWC7HXJ.js")).default;
    case "tl_PH":
      return (await import("./tl-SUUZJSKP.js")).default;
    case "vi_VN":
      return (await import("./vi-3NAVGQG4.js")).default;
    case "de_DE":
      return (await import("./de-RYQOANRD.js")).default;
    case "ko_KR":
      return (await import("./kr-5CJBTD7O.js")).default;
    case "fr_FR":
      return (await import("./fr-JMZEX2OR.js")).default;
    case "ru_RU":
      return (await import("./ru-VXGI35GL.js")).default;
    case "pt_BR": {
      return (await import("./br-VQTL4GC6.js")).default;
    }
    case "zh_CN":
      return (await import("./zh-IUE5ZPSW.js")).default;
    default:
      return (await import("./en-EU6QAYCO.js")).default;
  }
}
...
var QRCode = (props) => {
  ...
  return (0, import_jsx_runtime13.jsxs)("div", { style: {
    ...
    justifyContent: "center",
    position: "relative"
  }, children: [props.qrCodeUri ? (0, import_jsx_runtime13.jsx)(import_react11.Suspense, { fallback: placeholder, children: (0, import_jsx_runtime13.jsx)(QRCodeContainer, { children: (0, import_jsx_runtime13.jsx)(QRCodeRenderer, { clearSize: props.QRIcon ? 70 : void 0, ecl: "M", size: size + 20, uri: props.qrCodeUri }) }) }) : placeholder, props.QRIcon && (0, import_jsx_runtime13.jsx)(IconContainer, { children: props.QRIcon })] });
};
...
var GetStartedScreen = ({ wallet, walletInfo, header, footer, onBack, locale, client }) => {
  const [showScreen, setShowScreen] = (0, import_react12.useState)("base");
  ...
  return (0, import_jsx_runtime14.jsx)(Container, { animate: "fadein", flex: "column", fullHeight: true, children: (0, import_jsx_runtime14.jsxs)(Container, { expand: true, flex: "column", p: "lg", children: [showScreen === "android-scan" && walletInfo.app.android && (0, import_jsx_runtime14.jsx)(InstallScanScreen, { client, locale: {
    scanToDownload: locale.getStartedScreen.instruction
  }, onBack: handleBack, platform: "Google Play", platformIcon: (0, import_jsx_runtime14.jsx)(PlayStoreIcon, { size: iconSize.md }), url: walletInfo.app.android, walletId: wallet.id, walletName: walletInfo.name }), showScreen === "ios-scan" && walletInfo.app.ios && (0, import_jsx_runtime14.jsx)(InstallScanScreen, { client, locale: {
    scanToDownload: locale.getStartedScreen.instruction
  }, onBack: handleBack, platform: "App Store", platformIcon: (0, import_jsx_runtime14.jsx)(AppleIcon, { size: iconSize.md }), url: walletInfo.app.ios, walletId: wallet.id, walletName: walletInfo.name }), showScreen === "base" && (0, import_jsx_runtime14.jsxs)(Container, { expand: true, flex: "column", children: [header || (0, import_jsx_runtime14.jsx)(ModalHeader, { onBack: handleBack, title: walletInfo.name }), (0, import_jsx_runtime14.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime14.jsx)(Container, { animate: "fadein", center: "y", expand: true, flex: "column", style: {
    minHeight: "250px"
...
var InstallScanScreen = (props) => {
  return (0, import_jsx_runtime14.jsxs)(Container, { animate: "fadein", expand: true, children: [(0, import_jsx_runtime14.jsx)(ModalHeader, { onBack: props.onBack, title: props.walletName }), (0, import_jsx_runtime14.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime14.jsxs)(Container, { center: "both", expand: true, flex: "column", style: {
    textAlign: "center"
  }, children: [(0, import_jsx_runtime14.jsx)(QRCode, { QRIcon: (0, import_jsx_runtime14.jsx)(WalletImage, { client: props.client, id: props.walletId, size: iconSize.xxl }), qrCodeUri: props.url }), (0, import_jsx_runtime14.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime14.jsx)(Text, { balance: true, center: true, multiline: true, children: props.locale.scanToDownload }), (0, import_jsx_runtime14.jsx)(Spacer, { y: "xs" })] })] });
};
...
var ScanScreen = (props) => {
  ...
  const [linkCopied, setLinkCopied] = (0, import_react13.useState)(false);
  return (0, import_jsx_runtime15.jsxs)(Container, { animate: "fadein", flex: "column", fullHeight: true, className: "tw-qr-scan-screen", children: [(0, import_jsx_runtime15.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime15.jsx)(ModalHeader, { onBack: props.onBack, title: props.walletName }) }), (0, import_jsx_runtime15.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime15.jsxs)(Container, { center: "both", expand: true, flex: "column", px: "lg", children: [!props.error && (0, import_jsx_runtime15.jsxs)("div", { style: {
    textAlign: "center"
  }, children: [(0, import_jsx_runtime15.jsx)(QRCode, { QRIcon: (0, import_jsx_runtime15.jsx)(WalletImage, { client, id: props.walletId, size: iconSize.xxl }), qrCodeUri: props.qrCodeUri }), (0, import_jsx_runtime15.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime15.jsxs)(Button, { className: "tw-copy-link-button", disabled: props.qrCodeUri === void 0, onClick: () => {
  ...
  }, variant: "link", children: [linkCopied ? (0, import_jsx_runtime15.jsx)(CheckIcon, { height: 14, width: 14 }) : (0, import_jsx_runtime15.jsx)(CopyIcon, { height: 14, width: 14 }), (0, import_jsx_runtime15.jsx)("span", { style: { padding: "0 4px" }, children: "Copy Link" })] }), (0, import_jsx_runtime15.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime15.jsx)(Text, { balance: true, center: true, multiline: true, className: "tw-screen-description", style: {
    paddingInline: spacing.lg
  }, children: props.qrScanInstruction })] }), props.error && (0, import_jsx_runtime15.jsxs)(Container, { animate: "fadein", style: {
    width: "100%"
  }, children: [(0, import_jsx_runtime15.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime15.jsx)(Container, { center: "x", flex: "row", children: (0, import_jsx_runtime15.jsx)(AccentFailIcon, { size: iconSize["3xl"] }) }), (0, import_jsx_runtime15.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime15.jsx)(Text, { center: true, color: "primaryText", size: "lg", className: "tw-screen-title", "data-status": "failed", children: "Connection Failed" }), (0, import_jsx_runtime15.jsx)(Spacer, { y: "3xl" }), (0, import_jsx_runtime15.jsx)(Button, { fullWidth: true, onClick: props.onRetry, variant: "accent", className: "tw-retry-button", children: "Try again" })] })] }), (0, import_jsx_runtime15.jsx)(Spacer, { y: "lg" }), props.onGetStarted && (0, import_jsx_runtime15.jsx)(ScreenBottomContainer, { style: {
    border: connectModalSize === "compact" ? void 0 : "none"
  }, children: (0, import_jsx_runtime15.jsx)(Button, { onClick: props.onGetStarted, className: "tw-get-started-button", style: {
    fontSize: fontSize.sm,
    textAlign: "center"
...
var WalletConnectConnection = (props) => {
  ...
  const [qrCodeUri, setQrCodeUri] = (0, import_react14.useState)();
  const [errorConnecting, setErrorConnecting] = (0, import_react14.useState)(false);
  const connect = (0, import_react14.useCallback)(() => {
    var _a;
  ...
  const scanStarted = (0, import_react14.useRef)(false);
  ...
  if (isMobile()) {
    return (0, import_jsx_runtime16.jsx)(ConnectingScreen, { client: props.client, errorConnecting, locale: {
  ...
  return (0, import_jsx_runtime16.jsx)(ScanScreen, { client: props.client, connectModalSize: props.size, error: errorConnecting, getStartedLink: locale.getStartedLink, onBack, onGetStarted, onRetry: connect, qrCodeUri, qrScanInstruction: locale.scanScreen.instruction, walletId: wallet.id, walletName: walletInfo.name });
};
var WalletConnectStandaloneConnection = (props) => {
  ...
  return (0, import_jsx_runtime16.jsx)(ScanScreen, { client: props.client, connectModalSize: props.size, error: errorConnecting, getStartedLink: locale.getStartedLink, onBack, onRetry: connect, qrCodeUri, qrScanInstruction: locale.scanScreen.instruction, walletId: wallet.id, walletName: walletInfo.name });
};
...
var DeepLinkConnectUI = (props) => {
  ...
  return (0, import_jsx_runtime17.jsxs)(Container, { animate: "fadein", children: [(0, import_jsx_runtime17.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime17.jsx)(ModalHeader, { onBack: props.onBack, title: props.walletInfo.name }) }), (0, import_jsx_runtime17.jsx)(Container, { animate: "fadein", center: "x", flex: "row", py: "3xl", children: (0, import_jsx_runtime17.jsx)(PulsatingContainer, { children: (0, import_jsx_runtime17.jsx)(WalletImage, { client: props.client, id: props.wallet.id, size: "80" }) }) }), (0, import_jsx_runtime17.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime17.jsxs)(ButtonLink, { fullWidth: true, gap: "xs", href: deeplink, variant: "accent", children: ["Continue in ", props.walletInfo.name, (0, import_jsx_runtime17.jsx)(ExternalLinkIcon, { height: iconSize.sm, width: iconSize.sm })] }) })] });
};
...
var InjectedConnectUI = (props) => {
  ...
  const [errorConnecting, setErrorConnecting] = (0, import_react16.useState)(false);
  const locale = props.locale;
  const connectToExtension = (0, import_react16.useCallback)(async () => {
    try {
  ...
  const connectPrompted = (0, import_react16.useRef)(false);
  ...
  return (0, import_jsx_runtime18.jsx)(ConnectingScreen, { client: props.client, errorConnecting, locale: {
    failed: locale.connectionScreen.failed,
    getStartedLink: locale.getStartedLink,
    inProgress: locale.connectionScreen.inProgress,
    instruction: locale.connectionScreen.instruction,
...
// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/AnyWalletConnectUI.js
var CoinbaseSDKWalletConnectUI = (0, import_react17.lazy)(() => import("./CoinbaseSDKConnection-2EPAYGZI.js"));
var InAppWalletConnectUI = (0, import_react17.lazy)(() => import("./InAppWalletConnectUI-MK5GNUW7.js"));
var EcosystemWalletConnectUI = (0, import_react17.lazy)(() => import("./EcosystemWalletConnectUI-J42ATJCG.js"));
function AnyWalletConnectUI(props) {
  var _a, _b, _c;
  const [screen, setScreen] = (0, import_react17.useState)("main");
  const { wallet } = props;
  ...
  if (!walletInfo.data) {
    ...
    if (injectedProvider) {
      return (0, import_jsx_runtime19.jsx)(InjectedConnectUI, { chain: props.chain, client: props.client, done: props.done, locale: localeFn(injectedProvider.info.name), onBack: props.onBack, size: props.size, wallet: props.wallet, walletName: injectedProvider.info.name });
    }
    return (0, import_jsx_runtime19.jsxs)(Container, { animate: "fadein", flex: "column", fullHeight: true, children: [(0, import_jsx_runtime19.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime19.jsx)(ModalHeader, { onBack: props.onBack, title: "Not Supported" }) }), (0, import_jsx_runtime19.jsxs)(Container, { center: "both", expand: true, flex: "column", p: "lg", style: {
      minHeight: "300px"
    }, children: [(0, import_jsx_runtime19.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime19.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime19.jsx)(Text, { center: true, color: "primaryText", children: "Wallet is not supported" }), (0, import_jsx_runtime19.jsx)(Spacer, { y: "xxl" })] })] });
  }
  ...
  if (screen === "get-started") {
    return (0, import_jsx_runtime19.jsx)(GetStartedScreen, { client: props.client, locale, onBack: () => {
      setScreen("main");
  ...
  if (((_c = walletInfo.data.deepLink) == null ? void 0 : _c.mobile) && shouldDeeplink) {
    return (0, import_jsx_runtime19.jsx)(DeepLinkConnectUI, { client: props.client, deepLinkPrefix: walletInfo.data.deepLink.mobile, locale, onBack: props.onBack, onGetStarted: () => {
      setScreen("get-started");
    }, wallet: props.wallet, walletInfo: walletInfo.data });
  }
  if (walletInfo.data.rdns && isInstalled) {
    return (0, import_jsx_runtime19.jsx)(InjectedConnectUI, { chain: props.chain, client: props.client, done: props.done, locale, onBack: props.onBack, onGetStarted: () => {
      setScreen("get-started");
  ...
  if (walletInfo.data.mobile.native || walletInfo.data.mobile.universal) {
    return (0, import_jsx_runtime19.jsx)(WalletConnectConnection, { chain: props.chain, chains: props.chains, client: props.client, done: props.done, locale, onBack: props.onBack, onGetStarted: () => {
      setScreen("get-started");
  ...
  if (props.wallet.id === "walletConnect") {
    return (0, import_jsx_runtime19.jsx)(WalletConnectStandaloneConnection, { chain: props.chain, chains: props.chains, client: props.client, done: props.done, locale, onBack: props.onBack, setModalVisibility: props.setModalVisibility, size: props.size, wallet: props.wallet, walletConnect: props.walletConnect, walletInfo: walletInfo.data });
  }
  if (props.wallet.id === "inApp" || props.wallet.id === "embedded") {
    return (0, import_jsx_runtime19.jsx)(import_react17.Suspense, { fallback: (0, import_jsx_runtime19.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime19.jsx)(InAppWalletConnectUI, { chain: props.chain, client: props.client, connectLocale: props.connectLocale, done: props.done, goBack: props.onBack, meta: props.meta, size: props.size, wallet: props.wallet, walletConnect: props.walletConnect }) });
  }
  if (isEcosystemWallet(props.wallet.id)) {
    return (0, import_jsx_runtime19.jsx)(import_react17.Suspense, { fallback: (0, import_jsx_runtime19.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime19.jsx)(EcosystemWalletConnectUI, { chain: props.chain, client: props.client, connectLocale: props.connectLocale, done: props.done, goBack: props.onBack, meta: props.meta, size: props.size, wallet: props.wallet, walletConnect: props.walletConnect }) });
  }
  if (props.wallet.id) {
    return (0, import_jsx_runtime19.jsx)(import_react17.Suspense, { fallback: (0, import_jsx_runtime19.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime19.jsx)(CoinbaseSDKWalletConnectUI, { chain: props.chain, client: props.client, done: props.done, locale, onBack: props.onBack, onGetStarted: () => {
      setScreen("get-started");
    }, size: props.size, wallet: props.wallet, walletInfo: walletInfo.data }) });
  }
  return (0, import_jsx_runtime19.jsx)(GetStartedScreen, { client: props.client, locale, onBack: props.onBack, wallet: props.wallet, walletInfo: walletInfo.data });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/SmartWalletConnectUI.js
function SmartConnectUI(props) {
  const personalWalletInfo = useWalletInfo(props.personalWallet.id);
  const [keyConnected, setKeyConnected] = (0, import_react18.useState)(false);
  if (!personalWalletInfo.data) {
    return (0, import_jsx_runtime20.jsx)(LoadingScreen, {});
  }
  if (!keyConnected) {
    return (0, import_jsx_runtime20.jsx)(AnyWalletConnectUI, { chain: props.chain, chains: props.chains, client: props.client, connectLocale: props.connectLocale, done: () => {
  ...
  return (0, import_jsx_runtime20.jsx)(SmartWalletConnecting, { accountAbstraction: props.accountAbstraction, client: props.client, done: props.done, localeId: props.connectLocale.id, onBack: props.onBack, personalWallet: props.personalWallet, personalWalletInfo: personalWalletInfo.data, size: props.size });
}
function SmartWalletConnecting(props) {
  ...
  const { done } = props;
  const [smartWalletConnectionStatus, setSmartWalletConnectionStatus] = (0, import_react18.useState)("idle");
  ...
  if (smartWalletConnectionStatus === "connect-error") {
    return (0, import_jsx_runtime20.jsx)(Container, { animate: "fadein", center: "both", flex: "column", fullHeight: true, p: "lg", style: {
      minHeight: "300px"
    }, children: (0, import_jsx_runtime20.jsx)(Text, { color: "danger", children: localeQuery.data.failedToConnect }) });
  }
  return (0, import_jsx_runtime20.jsxs)(Container, { center: "both", flex: "column", fullHeight: true, style: {
    minHeight: "300px"
  }, children: [(0, import_jsx_runtime20.jsx)(Text, { center: true, color: "primaryText", multiline: true, children: localeQuery.data.connecting }), (0, import_jsx_runtime20.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime20.jsx)(Spinner, { color: "accentText", size: "lg" })] });
}
...
function TOS(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(Container, { center: "x", flex: "row", children: (0, import_jsx_runtime21.jsxs)(Text, { balance: true, center: true, inline: true, multiline: true, size: "xs", style: {
    maxWidth: "250px"
  }, children: [requireApproval && (0, import_jsx_runtime21.jsx)("input", { checked: props.isApproved, disabled: !requireApproval, onChange: props.onApprove, style: {
    marginRight: spacing["3xs"],
    transform: "translateY(3px)"
  }, type: "checkbox" }), locale.prefix, " ", termsOfServiceUrl && (0, import_jsx_runtime21.jsxs)(Link, { href: termsOfServiceUrl, inline: true, size: "xs", style: {
    whiteSpace: "nowrap"
  }, target: "_blank", children: [" ", locale.termsOfService, " "] }), bothGiven && `${locale.and} `, privacyPolicyUrl && (0, import_jsx_runtime21.jsx)(Link, { href: privacyPolicyUrl, inline: true, size: "xs", target: "_blank", children: locale.privacyPolicy }), !privacyPolicyUrl && !termsOfServiceUrl && (0, import_jsx_runtime21.jsx)(Text, { inline: true, size: "xs", children: "Terms of Service and Privacy Policy" })] }) });
}
...
function PoweredByThirdweb(props) {
  ...
  return (0, import_jsx_runtime23.jsx)(Link, { color: "secondaryText", hoverColor: "primaryText", href: link, target: "_blank", children: (0, import_jsx_runtime23.jsxs)(Container, { center: "both", flex: "row", style: {
    color: "currentColor",
    gap: 4
  }, children: [(0, import_jsx_runtime23.jsx)(Text, { size: "xs", style: {
    color: "currentColor"
  }, weight: 600, children: "Powered by" }), (0, import_jsx_runtime23.jsx)(ThirdwebTextIcon, { height: 11 })] }) });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/WalletSelector.js
var inAppWalletId = "inApp";
function WalletSelector(props) {
  const [personalWallet, setPersonalWallet] = (0, import_react20.useState)(null);
  if (!props.accountAbstraction) {
    return (0, import_jsx_runtime24.jsx)(WalletSelectorInner, { ...props });
  }
  if (personalWallet) {
    return (0, import_jsx_runtime24.jsx)(SmartConnectUI, { accountAbstraction: props.accountAbstraction, chain: props.chain, chains: props.chains, client: props.client, connectLocale: props.connectLocale, done: props.done, meta: props.meta, onBack: props.goBack, personalWallet, setModalVisibility: props.setModalVisibility, size: props.size, walletConnect: props.walletConnect });
  }
...
var WalletSelectorInner = (props) => {
  ...
  const [isWalletGroupExpanded, setIsWalletGroupExpanded] = (0, import_react20.useState)(false);
  const [approvedTOS, setApprovedTOS] = (0, import_react20.useState)(false);
  const installedWallets = getInstalledWallets();
  const lastUsedWalletId = (0, import_react20.useMemo)(() => getLastUsedWalletId(), []);
  ...
  const continueAsGuest = localWalletConfig && (0, import_jsx_runtime24.jsx)(Button, { "data-test": "continue-as-guest-button", disabled: props.meta.requireApproval && !approvedTOS, fullWidth: true, onClick: () => {
  ...
  const enableTWIconLink = (0, import_react20.useRef)(false);
  (0, import_react20.useEffect)(() => {
    setTimeout(() => {
      enableTWIconLink.current = true;
    }, 1e3);
  }, []);
  const twTitle = props.modalHeader ? (0, import_jsx_runtime24.jsx)(ModalHeader, { onBack: props.modalHeader.onBack, title: props.modalHeader.title }) : (0, import_jsx_runtime24.jsxs)(Container, { center: "y", flex: "row", gap: "xs", className: "tw-header", children: [!props.meta.titleIconUrl ? null : (0, import_jsx_runtime24.jsx)(Img, { client: props.client, height: iconSize.md, src: props.meta.titleIconUrl, width: iconSize.md }), (0, import_jsx_runtime24.jsxs)(ModalTitle, { children: [" ", props.title, " "] })] });
  const handleSelect = async (wallet) => {
    props.selectWallet(wallet);
  };
  const connectAWallet = (0, import_jsx_runtime24.jsx)(WalletTypeRowButton, { className: "tw-select-connect-a-wallet-button", lastUsedBadge: !!lastUsedWalletId && lastUsedWalletId !== "inApp" && !lastUsedWalletId.startsWith("ecosystem."), client: props.client, disabled: props.meta.requireApproval && !approvedTOS, icon: OutlineWalletIcon, onClick: () => {
    setIsWalletGroupExpanded(true);
  }, title: props.connectLocale.connectAWallet });
  const newToWallets = (0, import_jsx_runtime24.jsxs)(Container, { className: "tw-get-started-container", flex: "row", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime24.jsx)(Text, { color: "secondaryText", size: "sm", weight: 500, children: props.connectLocale.newToWallets }), (0, import_jsx_runtime24.jsx)(Link, { href: "https://blog.thirdweb.com/web3-wallet/", size: "sm", target: "_blank", weight: 500, children: props.connectLocale.getStarted })] });
  const tos = props.meta.requireApproval || props.meta.termsOfServiceUrl || props.meta.privacyPolicyUrl ? (0, import_jsx_runtime24.jsx)(TOS, { isApproved: approvedTOS, locale: props.connectLocale.agreement, onApprove: () => setApprovedTOS(!approvedTOS), privacyPolicyUrl: props.meta.privacyPolicyUrl, requireApproval: props.meta.requireApproval, termsOfServiceUrl: props.meta.termsOfServiceUrl }) : void 0;
  let topSection;
  let bottomSection;
  if (!isCompact) {
    topSection = (0, import_jsx_runtime24.jsx)(WalletSelection, { chain: props.chain, client: props.client, connectLocale: props.connectLocale, diableSelectionDataReset: props.disableSelectionDataReset, disabled: props.meta.requireApproval && !approvedTOS, done: props.done, goBack: props.goBack, onShowAll: props.onShowAll, recommendedWallets: props.recommendedWallets, selectWallet: handleSelect, showAllWallets: props.showAllWallets, size: props.size, wallets: nonLocalWalletConfigs });
    if (continueAsGuest) {
      ...
      if (!isWalletGroupExpanded) {
        ...
        if (eoaWallets.length === 0) {
          ...
          if (eoaWallets.length > 1) {
            bottomSection = (0, import_jsx_runtime24.jsxs)(Container, { flex: "column", gap: "sm", style: { position: "relative" }, children: [(0, import_jsx_runtime24.jsx)(GradientDiv, {}), (0, import_jsx_runtime24.jsxs)(Container, { flex: "column", gap: "md", px: "lg", children: [connectAWallet, continueAsGuest] }), tos ? (0, import_jsx_runtime24.jsxs)(Container, { p: "md", children: [" ", tos, " "] }) : (0, import_jsx_runtime24.jsx)(Spacer, { y: "xxs" })] });
          } else {
            bottomSection = (0, import_jsx_runtime24.jsxs)(import_jsx_runtime24.Fragment, { children: [(0, import_jsx_runtime24.jsx)(Container, { px: "lg", children: (0, import_jsx_runtime24.jsx)(WalletSelection, { chain: props.chain, client: props.client, connectLocale: props.connectLocale, diableSelectionDataReset: props.disableSelectionDataReset, disabled: props.meta.requireApproval && !approvedTOS, done: props.done, goBack: props.goBack, onShowAll: props.onShowAll, recommendedWallets: props.recommendedWallets, selectWallet: handleSelect, showAllWallets: props.showAllWallets, size: props.size, wallets: eoaWallets }) }), continueAsGuest && (0, import_jsx_runtime24.jsx)(Container, { flex: "column", gap: "lg", px: "lg", children: continueAsGuest }), tos ? (0, import_jsx_runtime24.jsxs)(import_jsx_runtime24.Fragment, { children: [continueAsGuest ? (0, import_jsx_runtime24.jsx)(Spacer, { y: "md" }) : (0, import_jsx_runtime24.jsx)(Line, {}), (0, import_jsx_runtime24.jsxs)(Container, { p: "md", children: [" ", tos, " "] })] }) : continueAsGuest && (0, import_jsx_runtime24.jsx)(Spacer, { y: "xl" })] });
          }
        }
      } else {
  ...
  return (0, import_jsx_runtime24.jsxs)(Container, { animate: "fadein", className: "tw-wallet-selection", flex: "column", fullHeight: true, scrollY: true, style: {
    maxHeight: props.size === "compact" ? compactModalMaxHeight : void 0
  }, children: [showHeader && (0, import_jsx_runtime24.jsx)(Container, { px: "lg", pt: "lg", pb: "xs", children: isWalletGroupExpanded ? (0, import_jsx_runtime24.jsx)(ModalHeader, { onBack: () => {
    setIsWalletGroupExpanded(false);
  }, title: twTitle }) : twTitle }), (0, import_jsx_runtime24.jsxs)(Container, { expand: true, scrollY: true, style: !showHeader ? {
    paddingTop: spacing.md
  } : {
    paddingTop: "2px"
  }, children: [!showHeader && isWalletGroupExpanded && (0, import_jsx_runtime24.jsx)(Container, { px: "md", children: (0, import_jsx_runtime24.jsx)(Container, { center: "y", flex: "row", style: {
    padding: spacing.sm,
    paddingTop: 0
  ...
  }, children: [(0, import_jsx_runtime24.jsx)(ChevronLeftIcon, { height: iconSize.sm, width: iconSize.sm }), props.connectLocale.goBackButton] }) }) }), topSection] }), bottomSection, isCompact && props.meta.showThirdwebBranding !== false && (0, import_jsx_runtime24.jsx)(Container, { py: "md", children: (0, import_jsx_runtime24.jsx)(PoweredByThirdweb, {}) })] });
};
...
var WalletSelection = (props) => {
  ...
  return (0, import_jsx_runtime24.jsxs)(WalletList, { style: {
    ...
    return (0, import_jsx_runtime24.jsx)("li", { children: wallet.id === "inApp" && props.size === "compact" ? (0, import_jsx_runtime24.jsx)(InAppWalletSelectionUI_default, { chain: props.chain, client: props.client, connectLocale: props.connectLocale, disabled: props.disabled, done: () => props.done(wallet), goBack: props.goBack, recommendedWallets: props.recommendedWallets, select: () => props.selectWallet(wallet), size: props.size, wallet }) : (0, import_jsx_runtime24.jsx)(WalletEntryButton, { className: "tw-wallet-select-wallet-button", badge: lastUsedWalletId === wallet.id ? "Last used" : void 0, client: props.client, connectLocale: props.connectLocale, isActive, recommendedWallets: props.recommendedWallets, selectWallet: () => {
      if (!props.diableSelectionDataReset) {
        setSelectionData({});
      }
      props.selectWallet(wallet);
    }, wallet }) }, wallet.id);
  }), props.onShowAll && props.showAllWallets !== false && (0, import_jsx_runtime24.jsx)(ButtonContainer, { className: "tw-show-all-wallets-button", children: (0, import_jsx_runtime24.jsxs)(WalletButtonEl, { onClick: props.onShowAll, children: [(0, import_jsx_runtime24.jsxs)(ShowAllWalletsIcon, { children: [(0, import_jsx_runtime24.jsx)("div", { "data-dot": true }), (0, import_jsx_runtime24.jsx)("div", { "data-dot": true }), (0, import_jsx_runtime24.jsx)("div", { "data-dot": true }), (0, import_jsx_runtime24.jsx)("div", { "data-dot": true })] }), (0, import_jsx_runtime24.jsxs)(Container, { flex: "row", gap: "xs", children: [(0, import_jsx_runtime24.jsx)(Text, { color: "primaryText", children: "All Wallets" }), (0, import_jsx_runtime24.jsx)(BadgeText, { children: " 500+ " })] })] }) })] });
};
...
function WalletAuth(props) {
  ...
  const walletToConnect = (0, import_react21.useRef)(void 0);
  const [status, setStatus] = (0, import_react21.useState)("selecting");
  ...
  if (!walletToConnect.current) {
    if (showAll) {
      return (0, import_jsx_runtime25.jsx)(import_react21.Suspense, { fallback: (0, import_jsx_runtime25.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime25.jsx)(AllWalletsUI_default, { client: props.client, connectLocale: props.locale, disableSelectionDataReset: true, onBack: () => setShowAll(false), onSelect: async (newWallet) => {
        login(newWallet);
        setShowAll(false);
      }, recommendedWallets: void 0, size: props.size }) });
    }
    return (0, import_jsx_runtime25.jsx)(WalletSelector, { chain: wallet.getChain(), chains: [], client: props.client, connectLocale: props.locale, disableSelectionDataReset: true, done: () => {
  ...
  return (0, import_jsx_runtime25.jsxs)(Container, { animate: "fadein", flex: "column", fullHeight: true, children: [(0, import_jsx_runtime25.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime25.jsx)(ModalHeader, { onBack: back, title: props.isLinking ? props.inAppLocale.linkWallet : props.inAppLocale.signInWithWallet }) }), (0, import_jsx_runtime25.jsx)(Container, { center: "y", expand: true, flex: "column", px: props.size === "wide" ? "xxl" : "lg", children: (0, import_jsx_runtime25.jsx)("div", { children: status === "error" ? (0, import_jsx_runtime25.jsxs)(import_jsx_runtime25.Fragment, { children: [(0, import_jsx_runtime25.jsx)(ErrorState, { onTryAgain: () => {
    if (!walletToConnect.current) {
      throw new Error("Failed to connect to unknown wallet");
    }
    login(walletToConnect.current);
  }, title: error || "Failed to Login" }), (0, import_jsx_runtime25.jsx)(Spacer, { y: "lg" })] }) : (0, import_jsx_runtime25.jsx)(LoadingState, { icon: (0, import_jsx_runtime25.jsx)(WalletImage, { client: props.client, id: walletToConnect.current.id ?? "", size: iconSize.xl }), subtitle: "A pop-up prompt will appear to sign-in and verify your wallet", title: "Sign in with your wallet" }) }) })] });
}
...
//# sourceMappingURL=chunk-Q6J7FO7L.js.map
