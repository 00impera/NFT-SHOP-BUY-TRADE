...
async function isOpStackChain(chain) {
  ...
  try {
    const { getChainMetadata } = await import("./utils-PYW646L7.js");
...
async function estimateGasCost(options) {
  ...
  if (await isOpStackChain(transaction.chain)) {
    const { estimateL1Fee } = await import("./estimate-l1-fee-H5PXFYNM.js");
...
//# sourceMappingURL=chunk-WLVUSTEI.js.map
