...
function toHex3(value) {
  ...
  return concat(encode2(from2("address, bytes, bytes"), [
    to,
    data,
    toHex2(signature)
  ]), magicBytes);
...
function hashMessage(message, to_) {
  ...
  return keccak256(concat2(prefixBytes, messageBytes), to_);
}
...
function hashTypedData(parameters) {
  ...
  return keccak256(concat2(...parts.map((p) => fromHex(p))));
}
...
async function confirmContractDeployment(args) {
  ...
  const timeout = 6e4;
  const { isContractDeployed: isContractDeployed2 } = await import("./is-contract-deployed-HKKYBBZA.js");
...
async function deploySmartAccount(args) {
  ...
  const [{ sendTransaction }, { prepareTransaction }] = await Promise.all([
    import("./send-transaction-JBKIQEQ5.js"),
    import("./prepare-transaction-5W46YAKM.js")
  ]);
...
//# sourceMappingURL=chunk-4F3BLXWM.js.map
