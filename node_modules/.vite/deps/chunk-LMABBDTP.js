...
async function toSerializableTransaction(options) {
  ...
  if (isZkSync) {
    const { getZkGasFees } = await import("./send-eip712-transaction-L4UUQK7A.js");
  ...
  let [data, nonce, gas, feeData, to, accessList, value, authorizationList, type] = await Promise.all([
    ...
    (async () => {
      ...
      return from ? await import("./eth_getTransactionCount-UBYY5M4T.js").then(({ eth_getTransactionCount }) => eth_getTransactionCount(rpcRequest, {
...
//# sourceMappingURL=chunk-LMABBDTP.js.map
