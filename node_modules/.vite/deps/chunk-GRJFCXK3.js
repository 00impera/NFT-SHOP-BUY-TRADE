...
function createInAppWallet(args) {
    ...
    if (ecosystem) {
      ...
      if (smartAccountOptions) {
        ...
        if (executionMode === "EIP7702") {
          ...
          const preferredChain = (options == null ? void 0 : options.chain) ?? (defaultChainId ? getCachedChain(defaultChainId) : void 0);
          if (!preferredChain) {
  ...
  return {
    autoConnect: async (options) => {
      const { autoConnectInAppWallet } = await import("./wallet-RYSM54IC.js");
    ...
    connect: async (options) => {
      const { connectInAppWallet } = await import("./wallet-RYSM54IC.js");
      const connector = await getOrCreateInAppWalletConnector(options.client, connectorFactory, ecosystem);
      await resolveSmartAccountOptionsFromEcosystem();
...
//# sourceMappingURL=chunk-GRJFCXK3.js.map
