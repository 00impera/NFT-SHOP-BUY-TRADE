  ...
  return approve({
    asyncParams: async () => {
      ...
      if ("amount" in options) {
        const { decimals } = await import("./decimals-TZ2ONTGD.js");
...
async function createSmartAccount(options) {
  ...
  const account = {
    ...
    async signMessage({ message }) {
      ...
      const { smartAccountSignMessage } = await import("./signing-KNLBNTBQ.js");
    ...
    async signTypedData(typedData) {
      ...
      const { smartAccountSignTypedData } = await import("./signing-KNLBNTBQ.js");
    ...
    sendCalls: async (options2) => {
      const { inAppWalletSendCalls } = await import("./in-app-wallet-calls-IPZRMQXP.js");
    ...
    getCallsStatus: async (options2) => {
      const { inAppWalletGetCallsStatus } = await import("./in-app-wallet-calls-IPZRMQXP.js");
      return inAppWalletGetCallsStatus(options2);
    },
    getCallsStatusRaw: async (options2) => {
      const { inAppWalletGetCallsStatusRaw } = await import("./in-app-wallet-calls-IPZRMQXP.js");
...
//# sourceMappingURL=chunk-PVIA4G44.js.map
