...
import {
  ethereum
} from "./chunk-E7NNRRU5.js";
import {
  webLocalStorage
} from "./chunk-PAAPSL3C.js";
import {
  parseNftUri
} from "./chunk-V26UOJXR.js";
import {
  require_jsx_runtime
} from "./chunk-6PF5PHNV.js";
import {
  eth_getBalance
} from "./chunk-D3APBPFG.js";
import {
...
import {
  encodeAbiParameters
} from "./chunk-WLVUSTEI.js";
import {
  resolveScheme
} from "./chunk-Y3QMBBMH.js";
import {
  labelhash
...
async function getWalletBalance(options) {
  ...
  const tokenAddress = options.tokenAddress || (chain.id === 42429 ? "0x20c0000000000000000000000000000000000000" : void 0);
  if (tokenAddress && getAddress(tokenAddress) !== getAddress(NATIVE_TOKEN_ADDRESS)) {
    const { getBalance } = await import("./getBalance-NUBSLGRU.js");
    return getBalance({
      address,
...
var UNIVERSAL_RESOLVER_ADDRESS = "0xeeeeeeee14d718c2b47d9923deab1335e144eeee";
...
async function resolveName(options) {
  ...
  return withCache(async () => {
    ...
    const [name] = await reverse({
      ...
      if (typeof e === "object" && e !== null && "data" in e && typeof e.data === "string") {
...
function useWalletImage(id) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const { getInstalledWalletProviders: getInstalledWalletProviders2 } = await import("./mipdStore-OXH2CADG.js");
...
var EmailIcon = (props) => {
  return (0, import_jsx_runtime12.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 24 24", role: "presentation", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: "lucide lucide-mail-icon lucide-mail", style: { color: props.color }, children: [(0, import_jsx_runtime12.jsx)("path", { d: "m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7" }), (0, import_jsx_runtime12.jsx)("rect", { x: "2", y: "4", width: "20", height: "16", rx: "2" })] });
};
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DEQZRX5E.js.map
