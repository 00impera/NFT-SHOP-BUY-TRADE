import {
  signLoginPayload
} from "./chunk-SLQWOVBS.js";
import {
  getLinkedProfilesInternal,
  linkAccount,
  unlinkAccount
} from "./chunk-GRC6EVHE.js";
import {
  getLoginCallbackUrl,
  getLoginUrl,
  loginWithOauth,
...
var NON_ETHEREUM_WALLETS = ["xyz.abs"];
  ...
  async getAccount() {
    ...
    const _signTransaction = async (tx) => {
      ...
      const transaction = {
        ...
        data: tx.data,
        gas: hexlify(tx.gas),
        nonce: hexlify(tx.nonce) || toHex(await import("./eth_getTransactionCount-UBYY5M4T.js").then(({ eth_getTransactionCount }) => eth_getTransactionCount(rpcRequest, {
...
var InAppWebConnector = class {
  ...
  async passkeyAuth(args) {
    const { PasskeyWebClient } = await import("./passkeys-C7EE6HQJ.js");
...
//# sourceMappingURL=web-connector-YZ3HGLT2.js.map
