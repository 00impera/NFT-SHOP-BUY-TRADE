...
async function sendTransaction(options) {
  ...
  if (transaction.eip712) {
    const { sendEip712Transaction } = await import("./send-eip712-transaction-L4UUQK7A.js");
  ...
  if (gasless) {
    const { sendGaslessTransaction } = await import("./send-gasless-transaction-6TAP35LE.js");
...
//# sourceMappingURL=chunk-O3FSL5CA.js.map
