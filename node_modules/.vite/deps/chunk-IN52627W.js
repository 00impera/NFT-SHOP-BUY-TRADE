...
async function getZkGasFees(args) {
  ...
  if (gas === void 0 || maxFeePerGas === void 0 || maxPriorityFeePerGas === void 0) {
    ...
    try {
      ...
      const [{ estimateGas: estimateGas2 }, { getDefaultGasOverrides }] = await Promise.all([
        import("./estimate-gas-AY6JXS7P.js"),
        import("./fee-data-QHXKANOZ.js")
      ]);
      const [estimatedGas, gasOverrides] = await Promise.all([
        gas === void 0 ? estimateGas2({ transaction, from }) : Promise.resolve(gas),
...
//# sourceMappingURL=chunk-IN52627W.js.map
