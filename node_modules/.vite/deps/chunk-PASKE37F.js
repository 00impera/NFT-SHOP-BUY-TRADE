...
async function getNFTFromRPC(options) {
  ...
  const [uri, owner] = await Promise.all([
    ...
    options.includeOwner ? import("./ownerOf-RTA5B6MC.js").then((m) => m.ownerOf({ contract: options.contract, tokenId })).catch(() => null) : null
  ]);
...
//# sourceMappingURL=chunk-PASKE37F.js.map
